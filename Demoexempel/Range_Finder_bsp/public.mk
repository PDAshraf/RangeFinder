...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Range_finder.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Range_finder
SOPC_NAME := Range_finder
...
# setting SOPC_SYSID_BASE_ADDRESS is 0xc1460
SOPC_SYSID_FLAG += --sidp=0xc1460
ELF_PATCH_FLAG  += --sidp 0xc1460

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1624023153
SOPC_SYSID_FLAG += --timestamp=1624023153
ELF_PATCH_FLAG  += --timestamp 1624023153
